...
if (Yii::$app->user->isGuest) {
    ...
    <h1><?= $this->title; ?></h1>
    <br/>
    <a href="#" id="show_godroll_form">Обновлено: <?= $last_sync_godrolls; ?></a>
    <br/>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'wtype',
                'filter' => \yii\helpers\Html::activeDropDownList($searchModel, 'wtype', $weapon_types, ['class' => 'form-control', 'prompt' => 'Выберите']),
            ],
            'Name',
            'rpm',
            [
